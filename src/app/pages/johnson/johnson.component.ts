...
export default class JohnsonComponent {
  helpContent: HelpContent = {
    ...
    description: 'Herramienta para resolver problemas de secuenciación y ruta crítica usando el algoritmo de Johnson. Crea grafos, calcula tiempos y visualiza el camino crítico.',
    
    steps: [
      {
        number: 1,
        title: 'Agregar Actividades',
        description: 'Usa el botón "Agregar Actividad" para crear nuevas filas. Completa los campos:',
        image: 'assets/help/agregar-actividad.png',
      },
      {
        number: 2,
        title: 'Configurar Relaciones',
        description: 'En la columna "Secuencia", indica la relación entre nodos (Ej: A->B). Evita ciclos y auto-referencias.',
        image: 'assets/help/relaciones-nodos.png'
      },
      {
        number: 3,
        title: 'Establecer Pesos',
        description: 'Ingresa valores numéricos positivos en la columna "Peso" para los tiempos de cada actividad.',
        image: 'assets/help/establecer-pesos.png'
      },
      {
        number: 4,
        title: 'Generar Grafo',
        description: 'Haz clic en "Generar Grafo" para visualizar las relaciones. Asegúrate que todos los campos sean válidos.',
        image: 'assets/help/generar-grafo.png'
      },
      {
        number: 5,
        title: 'Manipular Vista',
        description: 'Usa los controles de zoom (+/-) y arrastra el canvas para navegar por grafos grandes.',
        image: 'assets/help/controles-vista.png'
      },
      {
        number: 6,
        title: 'Error: Auto-referencia',
        description: 'Si ves este error, revisa que ningún nodo apunte a sí mismo en la columna de secuencia.',
        image: 'assets/help/error-auto-referencia.png'
      },
      {
        number: 7,
        title: 'Interpretar Holguras',
        description: 'Las holguras indican el margen disponible para esa actividad sin afectar la ruta crítica.',
    ...
    images: [
      ...
      {
        url: 'assets/help/ruta-critica-ejemplo.png',
        caption: 'Ruta crítica resaltada',
        alt: 'Camino crítico en color rosa'
      }
    ],
  
    tips: [
      'Los nombres de nodos deben ser únicos y no vacíos',
      'Para eliminar una actividad, deja todos sus campos en blanco',
      'Usa doble clic en nodos para editar propiedades',
      'Exporta tu grafo regularmente para respaldar tu trabajo',
      'Los pesos decimales se redondearán automáticamente',
