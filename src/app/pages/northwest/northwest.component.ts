...
export default class NorthwestComponent {
  ...
  helpContent: HelpContent = {
    title: 'Método de esquina Nor Oeste',
    description:
      'El método del Noroeste es una técnica para encontrar una solución inicial factible en problemas de transporte. Luego, el método MODI (Modified Distribution) se utiliza para optimizar esta solución inicial.',
    steps: [
      {
        number: 1,
        title: 'Preparación de Datos',
        description:
          'Ingresa la matriz de costos, los valores de oferta (Supply) y demanda (Demand). Asegúrate que la suma de la oferta sea igual a la suma de la demanda.',
      },
      {
        number: 2,
        title: 'Solución Inicial - Método del Noroeste',
        description:
          'El algoritmo comienza en la esquina superior izquierda (noroeste) de la tabla y asigna la máxima cantidad posible según las restricciones de oferta y demanda disponibles.',
      },
      {
        number: 3,
        title: 'Optimización con MODI',
        description:
          'El método MODI optimiza la solución inicial calculando potenciales (U, V) y evaluando celdas no utilizadas para encontrar mejores rutas de distribución.',
      },
      {
        number: 4,
        title: 'Resultado Final',
        description:
          'Se muestra la matriz de asignación optimizada y el costo total mínimo alcanzado.',
      },
    ],
    tips: [
      'Verifica que los datos de entrada sean correctos antes de resolver',
      'La solución inicial del Noroeste no garantiza la optimalidad',
      'El método MODI iterará hasta encontrar la solución óptima',
      'Puedes resolver tanto problemas de minimización como de maximización',
    ],
    images: [
      {
        url: '/assets/help/northwest-example.png',
        caption: 'Ejemplo de una tabla de transporte',
        alt: 'Tabla de transporte con método del Noroeste',
      },
      {
        url: '/assets/help/modi-cycle.png',
        caption: 'Ciclo de mejora MODI',
        alt: 'Ejemplo de ciclo de mejora en método MODI',
      },
    ],
  };
